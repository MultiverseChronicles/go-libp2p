...
// Source: github.com/MultiverseChronicles/go-libp2p/network (interfaces: PeerScope)
//
// Generated by this command:
//
//	mockgen -package mocknetwork -destination mock_peer_scope.go github.com/MultiverseChronicles/go-libp2p/network PeerScope
//
