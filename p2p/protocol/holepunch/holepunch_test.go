...
import (
	...
	"github.com/MultiverseChronicles/go-libp2p/p2p/net/simconn"
	relayv2 "github.com/MultiverseChronicles/go-libp2p/p2p/protocol/circuitv2/relay"
	"github.com/MultiverseChronicles/go-libp2p/p2p/protocol/holepunch"
	holepunch_pb "github.com/MultiverseChronicles/go-libp2p/p2p/protocol/holepunch/pb"
...
// Prior to https://github.com/MultiverseChronicles/go-libp2p/pull/3044, go-libp2p would
...
func TestEndToEndSimConnectQUICReuse(t *testing.T) {
	...
	// See: https://github.com/MultiverseChronicles/go-libp2p/issues/3165#issuecomment-2700126706 for details.
	h1.Network().Listen(
