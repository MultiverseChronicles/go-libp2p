...
import (
	...
	"github.com/MultiverseChronicles/go-libp2p/p2p/net/nat/internal/nat"
	"github.com/stretchr/testify/require"
	"go.uber.org/mock/gomock"
)

//go:generate sh -c "go run go.uber.org/mock/mockgen -package nat -destination mock_nat_test.go github.com/MultiverseChronicles/go-libp2p/p2p/net/nat/internal/nat NAT"
