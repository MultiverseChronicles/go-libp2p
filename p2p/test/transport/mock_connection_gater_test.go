...
//
//	mockgen -package transport_integration -destination mock_connection_gater_test.go github.com/MultiverseChronicles/go-libp2p/core/connmgr ConnectionGater
//
