...
manager](https://pkg.go.dev/github.com/MultiverseChronicles/go-libp2p/core/connmgr#ConnManager),
...
captured in [go-libp2p#1640](https://github.com/MultiverseChronicles/go-libp2p/issues/1640).
