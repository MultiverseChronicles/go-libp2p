...
**Full Changelog**: https://github.com/MultiverseChronicles/go-libp2p/compare/v0.27.0...v0.28.0
...
* rcmgr: fix JSON marshalling of ResourceManagerStat peer map [2156](https://github.com/MultiverseChronicles/go-libp2p/pull/2156)
...
#### [Unlimited Relay v2](https://github.com/MultiverseChronicles/go-libp2p/pull/2125) <!-- omit in toc -->
...
### [Stop sending detailed error messages on closing QUIC connections](https://github.com/MultiverseChronicles/go-libp2p/pull/2112) <!-- omit in toc -->
